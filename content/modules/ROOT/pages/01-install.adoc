...
|`+rhel2+` |RHEL10 host where we will collect metrics from.

|`+rhel3+` |RHEL10 host where we will collect metrics from.

|`+rhel4+` |RHEL10 host where we will collect metrics from.
|===
